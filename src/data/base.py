...
class ImageData(ImageDataInterface):
  ...
  def __init__(self,
    ...
    Args:
      num_samples_splits: a dictionary, that maps splits ("train", and "test") to the corresponding number of samples.
...
class ImageTfdsData(ImageData):
  ...
  def __init__(self, dataset_builder, tfds_splits, image_key='image', **kwargs):
    ...
    Args:
      ...
      tfds_splits: a dictionary, that maps splits ("train",
  ...
  def _get_dataset_split(self, split_name, shuffle_files):
    ...
    #return self._dataset_builder[split_name]
